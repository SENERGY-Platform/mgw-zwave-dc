...
func TestMgwDeviceManagement(t *testing.T) {
	...
	config := configuration.Config{
		ConnectorId:             "mgw-zwave-dc",
		ZwaveMqttClientId:       "mgw-zwave-dc_zwave",
		MgwMqttClientId:         "mgw-zwave-dc_mgw",
		ZvaveValueEventTopic:    "zwave2mqtt/#",
		ZwaveMqttApiTopic:       "zwave2mqtt/_CLIENTS/ZWAVE_GATEWAY-SENERGY/api",
		ZwaveNetworkEventsTopic: "zwave2mqtt/_EVENTS/ZWAVE_GATEWAY-SENERGY",
		Debug:                   true,
	}
